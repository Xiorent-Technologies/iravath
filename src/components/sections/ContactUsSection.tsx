                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[250px]">
                    ...
                    <div className="bg-[#262829] rounded-2xl  p-4 md:p-6 flex flex-col justify-center">
                        ...
                        <div className="max-w-md">
                            ...
                            <div className="mb-6">
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <span className="text-white">sales@iravath.com</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            {/* Customer Support */}
                            <div className="mb-6">
                                <h3 className="text-base font-semibold text-white mb-3">CUSTOMER SUPPORT</h3>
                                <div className="space-y-3">
                                    <div className="flex items-center space-x-3">
                                        <div className="w-5 h-5 text-white">
                                            <svg fill="currentColor" viewBox="0 0 20 20">
                                        ...
                                        <span className="text-white">support@iravath.com</span>
                                    </div>
                                </div>
                            </div>
