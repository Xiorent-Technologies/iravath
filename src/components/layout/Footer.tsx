      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center mb-6">
              ...
              <span className="text-2xl font-bold">Iravath</span>
            </div>
            <p className="text-gray-400 mb-6 leading-relaxed">
              The premier launchpad for discovering and investing in the next generation of blockchain innovations.
            </p>
          ...
          {/* For Projects */}
          <div>
            <h3 className="text-lg font-semibold mb-6">For Projects</h3>
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Apply to Launch</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Project Guidelines</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Due Diligence</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Marketing Support</a></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 Iravath Launchpad. All rights reserved.
          </p>
